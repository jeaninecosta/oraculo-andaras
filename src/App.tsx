...
function RotaProtegida({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return (
    <div className="min-h-screen bg-mistico-fundo flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-mistico-fundo flex items-center justify-center p-4">
      <div className="glass rounded-2xl p-8 max-w-md text-center">
        ...
        <p className="text-cristal/70 mb-6">
          Seu pagamento está sendo processado. Você receberá um e-mail assim que seu acesso for liberado.
        </p>
        <button onClick={signOut} className="text-dourado/60 hover:text-dourado text-sm underline">
          Sair
        </button>
      </div>
    </div>
